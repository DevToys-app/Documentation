...
$(function () {
  ...
  async function renderMermaid() {
    const diagrams = Array.from(document.querySelectorAll('pre code.lang-mermaid'));
    const processedDiagrams = Array.from(document.querySelectorAll('pre.mermaid[data-mermaid]'));
